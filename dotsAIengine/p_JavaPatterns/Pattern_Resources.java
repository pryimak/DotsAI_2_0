...
public class Pattern_Resources {
	...
	public static String frames=buttons+"frames//";
	
	public static IconImage icon=new IconImage(Pattern_Resources.gui+"icon.png");
	
	public static JButton getButton(Pattern_AddComponent add,String icon,int X,int Y,int buttonName){
	...
	public static JButton getButton(Pattern_AddComponent add,String icon,int X,int Y,String buttonName){
		ImageIcon i=new ImageIcon(icon);
		JButton b=(JButton)add.component("button",X,Y,i.getIconWidth(),i.getIconHeight(),"",null);
		b.setName(buttonName);
		b.setIcon(i);
